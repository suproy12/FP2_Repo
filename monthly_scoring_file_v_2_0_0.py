...
data_sample = PandasParameterType(pd.DataFrame({"Country": pd.Series(["example_value"], dtype="object"), "Time": pd.Series(["2000-1-1"], dtype="datetime64[ns]"), "Balance": pd.Series(["example_value"], dtype="object"), "Product": pd.Series(["example_value"], dtype="object"), "Unit": pd.Series(["example_value"], dtype="object")}), enforce_shape=False)
